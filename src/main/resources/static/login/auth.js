var Auth = {
	vars: {
		...
		lowin_login: document.querySelector('.lowin-adlogin'),
		lowin_wrapper_height: 0,
		login_back_link: document.querySelector('.adlogin-back-link'),
		forgot_link: document.querySelector('.forgot-link'),
		login_link: document.querySelector('.adlogin-link'),
		login_btn: document.querySelector('.adlogin-btn'),
